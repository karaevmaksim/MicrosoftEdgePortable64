...
user in an INI file next to MicrosoftEdgePortable64.exe called MicrosoftEdgePortable64.ini.
...
copy AppNamePortable.ini from this directory to MicrosoftEdgePortable64.ini next to
MicrosoftEdgePortable64.exe. The options in the INI file are as follows:
